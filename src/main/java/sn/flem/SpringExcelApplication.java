...
public class SpringExcelApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		AddResponse addResponse = XmlUtil.xmlToObject(response,AddResponse.class);
		...
		DollarResponse dollarResponse = XmlUtil.xmlToObject(response1,DollarResponse.class);
